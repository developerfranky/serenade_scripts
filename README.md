...
zoom in | Presses command + +
zoom out | Presses command + -
system copy | Presses command + c (since sometimes serenade's interal command is buggy)
system cut | Presses command + x 
system paste | Presses command + v (works for multiple line selections)
